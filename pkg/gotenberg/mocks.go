...
func (engine *PdfEngineMock) Optimize(ctx context.Context, logger *zap.Logger, options OptimizeOptions, inputPath, outputPath string) error {
	return engine.OptimizeMock(ctx, logger, options, inputPath, outputPath)
}
