...
Feature: /forms/pdfengines/stamp/bulk
  ...
  Scenario: POST /forms/pdfengines/stamp/bulk (Bad Request - Missing File for Image Source)
    ...
    Then the response body should match string:
      """
      Invalid form data: bulk stamp entry 0 requires an uploaded stamp file for image or pdf source
      """
