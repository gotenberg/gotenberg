...
type (
	gotenbergNetworkCtxKey   struct{}
	gotenbergContainerCtxKey struct{}
)
...
func (s *scenario) iHaveADefaultGotenbergContainer(ctx context.Context) (context.Context, error) {
	...
	ctx = context.WithValue(ctx, gotenbergNetworkCtxKey{}, n)
...
func InitializeScenario(ctx *godog.ScenarioContext) {
	...
	ctx.After(func(ctx context.Context, sc *godog.Scenario, err error) (context.Context, error) {
		...
		n, ok := ctx.Value(gotenbergNetworkCtxKey{}).(*testcontainers.DockerNetwork)
		if !ok || n == nil {
			return ctx, nil
		}
		errRemove := n.Remove(ctx)
		if errRemove != nil {
